...
public class Dibujo
{
    ...
    {
    	int ovalos = numeroOvalos();
        return "Cantidad de óvalos existentes en el dibujo es: " + ovalos;
    }
    ...
    /*
     * Laboratorio 1: Devuelve el número de Ovalos existentes en pantalla
     * Solange Acosta - Ivonne Barco
     */
    public int numeroOvalos() {
        ...
        while( iter.hasNext( ) )
        {
            ...
            // Valida el tipo figura Ovalo
            if(f.darTipoFigura( ).equals(Ovalo.TIPO)) {
            	acum++;
            }
        }
